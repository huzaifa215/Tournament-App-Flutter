...
class _OTPVerificationState extends State<OTPVerification> {
  ...
  void initState() {
    super.initState();
    admobService.showOtpVerificationBannerAd();
  ...
  //Function to recieve otp message from firebase and authenticate
    ...
    await FirebaseAuth.instance.verifyPhoneNumber(
      ...
      verificationCompleted: (PhoneAuthCredential credential) async {
        ...
        DocumentSnapshot documentSnapshot = await usersCollectionReference
            ...
            .get();
        EndUser endUser = EndUser.fromMap(documentSnapshot.data());
        Navigator.of(context,rootNavigator: true).pop();
        if(endUser!=null){
          Navigator.pushAndRemoveUntil(
              context,
